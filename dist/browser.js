...
(function() {
  ...
  const VERSION = '0.1.66';
    ...
    // Function to reinitialize dynamic rows when containers become visible
    function reinitializeDynamicRowGroups() {
        console.log('🔄 Reinitializing dynamic row groups...');
        initDynamicRows();
    }
    ...
    document.addEventListener('form-wrapper-visibility:shown', function(event) {
        console.log('🔄 Container became visible, reinitializing dynamic rows');
        // Small delay to ensure DOM is updated
        setTimeout(function() {
            reinitializeDynamicRowGroups();
        }, 50);
    });
    ...
    window.CDFormLibrary = {
        ...
        reinitializeDynamicRowGroups: reinitializeDynamicRowGroups
    };
